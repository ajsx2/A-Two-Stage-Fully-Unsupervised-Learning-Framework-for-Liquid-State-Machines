...
def main():
    ...
    print(f"    Visualization samples: {n_visualization_samples}")
    
    visualizer = EnhancedVisualizationAndMonitoring(save_dir='./dual_som_memory_lsm_visualizations')
    ...
    spiking_boundary_threshold = 0.6
    ...
    dual_som.traditional_som.train_unsupervised(
        train_features.to(device), n_epochs=250,
        learning_rate=0.37, batch_size=128,
